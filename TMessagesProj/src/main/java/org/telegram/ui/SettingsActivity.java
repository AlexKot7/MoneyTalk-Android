...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        ...
        listView.setAdapter(new Glue.ListAdapterWrapper(listAdapter, getParentActivity()));
        listView.setOnItemClickListener(new Glue.OnItemClickListenerWrapper(new AdapterView.OnItemClickListener() {
            @Override
            ...
            if (type == 0) {
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "%s for Android v%s", Glue.getAppName(getParentActivity()), pInfo.versionName));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
