    ...
    public HashMap<Integer, File> createMediaPaths() {
        ...
        try {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                telegramPath = new File(Environment.getExternalStorageDirectory(), Glue.getAppName(ApplicationLoader.applicationContext));
                telegramPath.mkdirs();

                if (telegramPath.isDirectory()) {
                    try {
                        File imagePath = new File(telegramPath, Glue.getAppName(ApplicationLoader.applicationContext) + " Images");
                        imagePath.mkdir();
                    ...
                    try {
                        File videoPath = new File(telegramPath, Glue.getAppName(ApplicationLoader.applicationContext) + " Video");
                        videoPath.mkdir();
                    ...
                    try {
                        File audioPath = new File(telegramPath, Glue.getAppName(ApplicationLoader.applicationContext) + " Audio");
                        audioPath.mkdir();
                    ...
                    try {
                        File documentPath = new File(telegramPath, Glue.getAppName(ApplicationLoader.applicationContext) + " Documents");
                        documentPath.mkdir();
